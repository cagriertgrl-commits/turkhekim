...
export const IkonUroloji     = () => <svg {...S}><ellipse cx="12" cy="8" rx="4" ry="5"/><path d="M12 13v8"/><path d="M9 18c0 1.7 1.3 3 3 3s3-1.3 3-3"/><path d="M8 8c-2.5.5-4 2-4 4"/></svg>;
export const IkonKadin       = () => <svg {...S}><circle cx="12" cy="8" r="4"/><path d="M12 12v4"/><path d="M9 15h6"/><path d="M8 19c0 2.2 1.8 4 4 4s4-1.8 4-4c0-1.5-.8-2.8-2-3.5"/></svg>;
export const IkonGenelCerrahi= () => <svg {...S}><path d="M9 3h6l2 3H7L9 3z"/><path d="M7 6v2a5 5 0 0 0 10 0V6"/><line x1="12" y1="11" x2="12" y2="21"/><line x1="9" y1="17" x2="15" y2="17"/></svg>;
export const IkonFizikTedavi = () => <svg {...S}><circle cx="12" cy="5" r="2"/><path d="M8 21v-5l-2-3 4-4 2 3 2-3 4 4-2 3v5"/><path d="M12 9v4"/></svg>;
export const IkonGastro      = () => <svg {...S}><path d="M6 4c-1.5 2-2 4.5-2 7 0 4.4 3.6 8 8 8s8-3.6 8-8c0-2.5-.5-5-2-7"/><path d="M9 8c0 2.5.5 5 3 6.5C15 13 15.5 10.5 15 8"/><circle cx="12" cy="11" r="1" fill="currentColor" stroke="none"/></svg>;
export const IkonIcHastaliklari= () => <svg {...S}><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/><path d="M9 3.5C10 3.2 11 3 12 3"/></svg>;
